  ...
  return (
    <form className="form" onSubmit={handleSubmit} noValidate>
      <div className="section-head">
        ...
        <p className="section-note">Nothing leaves this device</p>
      </div>
      <div className="rule" />

      <fieldset className="fieldset">
        <legend className="eyebrow">Photo</legend>
      ...
      <fieldset className="fieldset">
        ...
        <div className="grid">
          ...
          <label className="field">
            ...
            <em className="hint">Used by the metabolic rate formula.</em>
          </label>
      ...
      <fieldset className="fieldset">
        <legend className="eyebrow">Your goal</legend>
        <div className="grid">
          <label className="field">
      ...
      <fieldset className="fieldset">
        <legend className="eyebrow">Food</legend>
        <div className="grid">
          <label className="field">
